...
With TestMu AI (Formerly LambdaTest), you can run Python-based tests across real browsers and operating systems. This sample shows how to configure the LambdaTest Python SDK to run on the TestMu AI cloud.
...
```bash
git clone https://github.com/LambdaTest/lambdatest-python-sdk
cd lambdatest-python-sdk
```

Install the SDK:

```bash
pip install lambdatest-sdk
```
...
Run your test suite using the SDK utilities. For example, using Selenium:
...
Run with Playwright integration similarly via the SDK's Playwright utilities.
